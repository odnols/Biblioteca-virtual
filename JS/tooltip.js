...
//----------------------------------------------------------------------------------------------------
	...
	this.bgColor = "rgba(0, 0, 0, .7)"; // background color
...
//----------------------------------------------------------------------------------------------------
	this.create = function() {
		...
		if(this.width) this.obj.style.minWidth = this.width + 'px';
		...
		if(this.borderRadius) this.obj.style.borderRadius = this.borderRadius;
